...
const callout={id:'note',targetId:'wall',levelId:'L0',anchor:[0,0] as [number,number],label:[1,1] as [number,number],text:'文字标注',createdAt:''};
...
describe('manual callout editing',()=>{
  ...
  it('keeps Shift+Enter as a newline and saves ordinary Enter',()=>{
    ...
    act(()=>editor.dispatchEvent(new KeyboardEvent('keydown',{key:'Enter',bubbles:true})));expect(update).toHaveBeenCalledWith('note',{text:'文字标注'});
  });
});
