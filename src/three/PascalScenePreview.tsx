...
function Beam({ node, selected, editable = true, onSelect, levelY, preview = false, onDrag, onSurfaceHit, onSurfaceMove, onSurfaceFinish }: { node: NodeData; selected: boolean; editable?: boolean; onSelect: () => void; levelY: number; preview?: boolean; onDrag?: (edit: BeamEdit, commit: boolean) => void; onSurfaceHit?: (hit: ThreeDSurfaceHit) => void; onSurfaceMove?: (hit: ThreeDSurfaceHit | null) => void; onSurfaceFinish?: () => void }) {
